/**
 * CSS Flip Counter
 * Copyright (c) 2016 Gregory Varghese
 * ===============================================================================================
 * 9-7-16
 * ===============================================================================================
 ...
 * ===============================================================================================
 * Original Copyright (c) 2013 Chris Nanney
 *
 * Forked from http://cnanney.com/journal/code/css-flip-counter-revisited/
 *
 * Licensed under MIT
...
var flipCounter = function(d, options){
    ...
    function _drawCounter(){
        ...
        if(digitsNew.length < counter.places)
        {
           for(var x = digitsNew.length, count = counter.places; x < count; x++)
            {
                html += '<li class="digit" id="'+x+'-digit-a'+x+'">'+
                    '<div class="line"></div>'+
